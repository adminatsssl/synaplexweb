...
import DRTContent from "./DRT/DRTContent.jsx";
import CriminalComplaintContent from "./CriminalComplaint/CriminalComplaintContent.jsx";
...
const CasesDetail = ({ caseData, lastUpdateTime }) => {
                ...
                <div className="Sarfasei-container">
                    ...
                    {caseData.CaseType?.toLowerCase() === "cheque bounce" &&
                        <ChequeBounceContent
                            ...
                            activeStageName={caseData.activeStageName}
                        />
                    }
