                        ...
                        {tenants.map((tenant) => (
                            <tr key={tenant.ID}>
                                ...
                                <td className="actions-cell">
                                    ...
                                    <button className="edit-btn" onClick={() => handleEditClick(tenant)} title="Edit">✏️</button>
                                    <button className="delete-btn" onClick={() => handleDeleteClick(tenant.ID)} title="Delete">🗑️</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
