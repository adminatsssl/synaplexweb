...
const DispositionNoticeGenerationArbitration = ({ isOpen, onClose, onSave }) => {
    ...
    const handleSave = () => {
  onSave({
    name: selectedStage,         // correct key for backend
    description: comment,        // correct key for backend
  });
};
...
export default DispositionNoticeGenerationArbitration;