            ...
            <div className="Sarfasei-notice-form-row">
              ...
              <div className="Sarfasei-notice-form-group">
                ...
                >
                  ...
                  <option value="Taking control of existing business">
                    Taking control of existing business
                  </option>
                  <option value="Appointing a receiver to manage assets">
                    Appointing a receiver to manage assets
                  </option>
                  <option value="Taking possession of assets">
